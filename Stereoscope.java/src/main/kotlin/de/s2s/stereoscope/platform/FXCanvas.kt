...
class FXCanvas(private val fxCanvas: Canvas, override var density: Density) : ICanvas {
    ...
    private val writeableImage = WritableImage(width, height)
    private val pixelWriter = writeableImage.pixelWriter
    private val pixelReader = writeableImage.pixelReader
